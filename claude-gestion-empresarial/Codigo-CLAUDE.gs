/*  ============================================================================
    CLAUDE PARA LA GESTIÓN EMPRESARIAL  —  Backend en Google Apps Script
    ----------------------------------------------------------------------------
    ...
    IMPORTANTE: este script va en una planilla PROPIA del curso de Claude,
    distinta de la de Clínica del Contador y de la de Excel + IA. Así las métricas
    y las secuencias de cada capacitación quedan separadas y no se pisan entre sí.
...
var VERSION_CODIGO = 'claude-gestion 2026-09-14';
...
var CONFIG = {
  ...
  WHATSAPP_LINK: 'https://wa.link/b0luoh',
  // Los dos de abajo solo se usan si dejás WHATSAPP_LINK vacío.
  WHATSAPP_NUMERO: '',
  WHATSAPP_MENSAJE: 'Buenas 👋 Recibí tu mail del curso de Claude para la Gestión ' +
                    'Empresarial, ¿me podrías brindar más información?',

  // Página del curso: es el link del pie de todos los emails.
  URL_LANDING: 'https://escencialconsultora.com.ar/cursos/1129/claude-para-la-gestion-empresarial-28-de-septiembre-del-2026-online',
  ...
  // --- Datos del curso que se muestran en los emails ---------------------------
  CURSO_NOMBRE: 'Claude para la Gestión Empresarial',
  CURSO_INICIO: 'Lunes 28/09',
  CURSO_HORARIO: '20 a 22 hs (Argentina)',
...
/* ============================================================================
   ...
   B) fechaFija  → una fecha y hora del calendario, igual para todos.
        Formato: 'AAAA-MM-DD HH:mm'   Ej: '2026-09-28 09:00'
...
var SECUENCIA_EMAILS = [
     ...
     -------------------------------------------------------------------------- */
  {
    ...
    esperaHoras: 0,
    asunto: 'Claude para la Gestión Empresarial | Toda la información',
    cuerpo: function (lead) {
      return '' +
        saludo('Hola 👋🏻') +
        p('Estamos próximos a iniciar <b>Claude para la Gestión Empresarial</b>, una ' +
          'capacitación pensada para <b>profesionales, emprendedores y equipos</b> que ' +
          'quieren incorporar la Inteligencia Artificial como una herramienta real de ' +
          'productividad, análisis, automatización y creación digital.') +
        p('Durante la capacitación vas a trabajar contenidos de:') +
        listaEmoji('🔹', [
          'Qué es Claude, sus modelos, planes de uso y buenas prácticas con IA',
          'Claude Chat: proyectos, documentos, prompts y manejo del contexto',
          'Instrucciones personalizadas y artefactos aplicados al trabajo',
          'Organización de tareas y planificación con Inteligencia Artificial',
          'Análisis de información y documentación de procesos',
          'Reportes de gestión y planes de acción',
          'Claude Code: páginas web, landing pages y herramientas de gestión',
          'Publicación de proyectos y soluciones digitales simples'
        ]) +
        fichaDatos([
          ['💻', 'Modalidad', 'Online en vivo por Zoom'],
          ['📅', 'Inicia', 'Lunes 28 de septiembre'],
          ['📚', 'Programa', '4 módulos · 5 encuentros'],
          ['🎓', 'Al finalizar', 'Certificado y clases grabadas']
        ]) +
        tablaHorarios() +
        p('🤖 Todas las clases son <b>en vivo por Zoom</b> y quedan <b>grabadas</b>, así que ' +
          'si un día no podés estar, podés verlas y repasarlas cuando quieras.') +
  ...
  /* --------------------------------------------------------------------------
     EMAIL 2 — Sale el JUEVES 24 DE SEPTIEMBRE a las 10:30, a todos los
     ...
     -------------------------------------------------------------------------- */
  {
    ...
    fechaFija: '2026-09-24 10:30',
    asunto: '🚨 Últimos cupos | Claude para la Gestión Empresarial',
    cuerpo: function (lead) {
      return '' +
        saludo('Hola 👋🏻') +
        p('Estamos en los <b>últimos cupos</b> para sumarte a <b>Claude para la Gestión ' +
          'Empresarial</b>.') +
        p('Una capacitación pensada para que puedas incorporar la Inteligencia Artificial ' +
          'a tu trabajo diario, sobre:') +
        listaEmoji('📌', [
          'Productividad: organización de tareas, planificación y contenidos',
          'Proyectos, documentos e instrucciones personalizadas',
          'Prompts y manejo del contexto para obtener mejores resultados',
          'Análisis de información y documentación de procesos',
          'Reportes de gestión y planes de acción',
          'Claude Code: páginas web y landing pages',
          'Herramientas de gestión y publicación de proyectos'
        ]) +
        p('El objetivo es que puedas usar <b>Claude</b> para gestionar, analizar y automatizar ' +
          'tareas, organizar información y crear soluciones digitales: menos trabajo ' +
          'repetitivo y mejor información para decidir.') +
        tablaHorarios() +
  ...
  /* --------------------------------------------------------------------------
     EMAIL 3 — Sale el LUNES 28 DE SEPTIEMBRE, día de inicio del curso.
     Está puesto a las 09:00 para que llegue a la mañana, bastante antes de
     la clase de las 20:00. Si lo querés más cerca del horario de cursada,
     cambiá la hora acá (por ejemplo '2026-09-28 17:00').
     -------------------------------------------------------------------------- */
  {
    id: 'e3_hoy_iniciamos',
    etiqueta: 'Hoy iniciamos',
    fechaFija: '2026-09-28 09:00',
    asunto: '🚀 Hoy iniciamos | Claude para la Gestión Empresarial',
    cuerpo: function (lead) {
      return '' +
        saludo('Hola 👋🏻') +
        p('<b>Hoy comienza Claude para la Gestión Empresarial.</b> 🎓') +
        p('Llegó el momento de incorporar la Inteligencia Artificial a tu trabajo: organizar ' +
          'información, analizar documentos, automatizar procesos y crear soluciones ' +
          'digitales con Claude.') +
        destacado('Claude aplicado a la gestión',
          'Proyectos · Documentos · Prompts · Informes · Productividad') +
        destacado('Análisis, automatización y creación digital',
          'Análisis · Automatización · Claude Code · Landing pages · IA') +
        tablaHorarios() +
...
var COLUMNAS_LEADS = [
  ...
  'Perfil profesional', 'Nivel en IA', 'País', 'Consulta', 'Consentimiento',
...
function registrarLead_(d) {
  ...
  var id = 'CLAUDE-' + Utilities.formatDate(ahora, Session.getScriptTimeZone(), 'yyyyMMdd-HHmmss');
    ...
    '<tr><td style="padding:0 32px 28px">' +
      '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:' + CONFIG.COLOR_FONDO + ';border-radius:12px">' +
        '<tr>' +
          ...
          celdaDato_(String(CONFIG.CURSO_ENCUENTROS), 'ENCUENTROS') +
        '</tr>' +
      '</table>' +
    '</td></tr>' +
...
function crearPanel_() {
  ...
  // H = "País" (C.PAIS = 8). Es la métrica clave de esta cursada: se dicta
  // en cuatro husos horarios distintos.
...
function enviarPruebaDePaso_(indice, silencioso) {
  var leadFalso = {
    ...
    perfil: 'Profesional independiente o consultor/a',
    pais: 'Argentina'
  };
 ...
 * Sirve para verificar los envíos del 24/09 y del 28/09 antes de que ocurran.
 */
function simularEnviosEnUnaFecha() {
  ...
  var resp = ui.prompt(
    ...
    'Ejemplos:  2026-09-24 10:30   ·   2026-09-28 09:00',
...
function simularLeadDePrueba() {
  var r = registrarLead_({
    ...
    telefono: '3410000000',
    perfil: 'Emprendedor/a o integrante de un equipo administrativo',
    nivel: 'Básico — todavía no uso herramientas de IA',
    pais: 'Argentina',
 ...
 *
 * Qué NO hace: no toca la programación de la secuencia. Los emails del 24 y del
 * 28 de septiembre siguen esperando su fecha; no se disparan por ejecutar esto.
 */
function prepararParaProduccion() {
  ...
  // El disparador es lo que dispara los envíos del 24 y del 28
