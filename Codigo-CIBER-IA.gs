/*  ============================================================================
    CIBERSEGURIDAD Y HERRAMIENTAS DE IA  —  Backend en Google Apps Script
    ----------------------------------------------------------------------------
    ...
    IMPORTANTE: este script va en una planilla PROPIA del curso de Ciberseguridad,
...
var VERSION_CODIGO = 'ciber-ia 2026-09-07';
...
var CONFIG = {
  ...
  WHATSAPP_LINK: 'https://wa.link/ylazw7',
  // Los dos de abajo solo se usan si dejás WHATSAPP_LINK vacío.
  WHATSAPP_NUMERO: '',
  WHATSAPP_MENSAJE: 'Buenas 👋 Recibí tu mail del curso de Ciberseguridad y ' +
                    'Herramientas de IA, ¿me podrías brindar más información?',

  // Página del curso: es el link del pie de todos los emails.
  URL_LANDING: 'https://escencialconsultora.com.ar/cursos/1080/ciberseguridad-empresarial-17-de-septiembre-del-2026-online',
  ...
  CURSO_NOMBRE: 'Ciberseguridad y Herramientas de IA',
  CURSO_INICIO: 'Jueves 17/09',
  CURSO_HORARIO: '20 a 22 hs (Argentina)',
  CURSO_MODALIDAD: 'Online en vivo',
  CURSO_MODULOS: 5,
...
/* ============================================================================
   ...
   B) fechaFija  → una fecha y hora del calendario, igual para todos.
        Formato: 'AAAA-MM-DD HH:mm'   Ej: '2026-09-17 09:00'
...
var SECUENCIA_EMAILS = [
     ...
     -------------------------------------------------------------------------- */
  {
    ...
    esperaHoras: 0,
    asunto: 'Ciberseguridad y Herramientas de IA | Toda la información',
    cuerpo: function (lead) {
      return '' +
        saludo('Hola 👋🏻') +
        p('Estamos próximos a iniciar con <b>Ciberseguridad y Herramientas de IA</b>, ' +
          'una capacitación pensada para <b>profesionales, equipos de empresas y perfiles ' +
          'técnicos</b> que trabajan con información digital y quieren prevenir riesgos, ' +
          'proteger datos y desenvolverse de forma más segura frente a las amenazas actuales.') +
        p('Durante la capacitación vas a trabajar contenidos de:') +
        listaEmoji('🔹', [
          'Fundamentos de ciberseguridad y amenazas reales',
          'Phishing, ransomware, ingeniería social y suplantación de identidad',
          'Contraseñas seguras, gestores (Bitwarden) y doble autenticación (2FA)',
          'Copias de seguridad, redes Wi-Fi y seguridad en dispositivos',
          'Herramientas prácticas: VirusTotal, Have I Been Pwned y navegación segura',
          'Marco legal en Argentina, Latinoamérica y el mundo digital',
          'Cultura de cumplimiento y compliance digital en la organización',
          'Seguridad por diseño, OWASP Top 10 y buenas prácticas en código'
        ]) +
        fichaDatos([
        ...
        tablaHorarios() +
        p('🤖 Además, vas a aprender a usar <b>ChatGPT y otras herramientas de IA</b> para ' +
          'detectar posibles fraudes, analizar riesgos y reforzar protocolos de seguridad ' +
  ...
  /* --------------------------------------------------------------------------
     EMAIL 2 — Sale el VIERNES 11 DE SEPTIEMBRE a las 10:30, a todos los
     ...
     -------------------------------------------------------------------------- */
  {
    ...
    fechaFija: '2026-09-11 10:30',
    asunto: '🚨 Últimos cupos | Ciberseguridad y Herramientas de IA',
    cuerpo: function (lead) {
      return '' +
        saludo('Hola 👋🏻') +
        p('Estamos en los <b>últimos cupos</b> para sumarte a <b>Ciberseguridad y ' +
          'Herramientas de IA</b>.') +
        p('Una capacitación pensada para incorporar herramientas prácticas que te permitan ' +
          'prevenir amenazas, proteger la información y fortalecer la cultura de prevención, ' +
          'trabajando sobre:') +
        listaEmoji('📌', [
          'Amenazas reales: phishing, ransomware e ingeniería social',
          'Superficie de ataque: qué expone hoy tu organización',
          'Gestores de contraseñas, 2FA y copias de seguridad',
          'VirusTotal, Have I Been Pwned y navegación segura',
          'Protección de datos: Ley 25.326, RGPD y normativa de la región',
          'Compliance digital: manuales de conducta, accesos y trazabilidad',
          'Seguridad por diseño y OWASP Top 10 para perfiles técnicos',
          'ChatGPT y otras IA aplicadas a la detección de fraudes'
        ]) +
        p('El objetivo es que puedas usar la <b>ciberseguridad y la Inteligencia Artificial</b> ' +
          'como herramientas concretas para trabajar de manera más segura y prevenir incidentes.') +
        tablaHorarios() +
  ...
  /* --------------------------------------------------------------------------
     EMAIL 3 — Sale el JUEVES 17 DE SEPTIEMBRE, día de inicio del curso.
     ...
     cambiá la hora acá (por ejemplo '2026-09-17 17:00').
     -------------------------------------------------------------------------- */
  {
    id: 'e3_hoy_iniciamos',
    etiqueta: 'Hoy iniciamos',
    fechaFija: '2026-09-17 09:00',
    asunto: '🚀 Hoy iniciamos | Ciberseguridad y Herramientas de IA',
    cuerpo: function (lead) {
      return '' +
        saludo('Hola 👋🏻') +
        p('<b>Hoy comienza Ciberseguridad y Herramientas de IA.</b> 🎓') +
        p('Llegó el momento de incorporar herramientas que te permitan reconocer amenazas, ' +
          'proteger la información con la que trabajás y fortalecer la cultura de prevención ' +
          'en tu organización.') +
        destacado('Ciberseguridad aplicada',
          'Amenazas reales · Prevención · Herramientas · Marco legal · Compliance digital') +
        destacado('Inteligencia Artificial como aliada',
          'ChatGPT · Detección de fraudes · Análisis de riesgos · Protocolos de seguridad') +
        tablaHorarios() +
...
var COLUMNAS_LEADS = [
  ...
  'Perfil profesional', 'Nivel en ciberseguridad', 'País', 'Consulta', 'Consentimiento',
...
function registrarLead_(d) {
  ...
  var id = 'CIBER-' + Utilities.formatDate(ahora, Session.getScriptTimeZone(), 'yyyyMMdd-HHmmss');
    ...
    '<tr><td style="padding:0 32px 28px">' +
      '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:' + CONFIG.COLOR_FONDO + ';border-radius:12px">' +
        '<tr>' +
          ...
          celdaDato_('Ciber + IA', 'HERRAMIENTAS') +
        '</tr>' +
      '</table>' +
    '</td></tr>' +
...
function crearPanel_() {
  ...
  // G = "Nivel en ciberseguridad" (C.NIVEL = 7)
...
function enviarPruebaDePaso_(indice, silencioso) {
  var leadFalso = {
    ...
    perfil: 'Profesional o integrante de un equipo de empresa',
    pais: 'Argentina'
  };
...
function simularLeadDePrueba() {
  var r = registrarLead_({
    ...
    telefono: '3410000000',
    perfil: 'Responsable de gestión, compliance o administración',
    nivel: 'Básico — quiero empezar desde cero',
    pais: 'Argentina',
